...
import { addSmurf, getError } from '../actions';
...
const AddForm = (props) => {
    ...
    const handleSubmit = e => {
        ...
        if (state.name === "" || state.position === "" || state.nickname === "") {
            props.getError("Name, position and nickname fields are required.");
        } else {
    ...
    return(<section>
        ...
        <form onSubmit={handleSubmit}>
            ...
            {
                props.errorMess && <div data-testid="errorAlert" className="alert alert-danger" role="alert">Error: {props.errorMess}</div>
            }
...
const mapStateToProps = (state) => {
    return{
        errorMess: state.error,
    }
}


export default connect(mapStateToProps, {getError, addSmurf})(AddForm);
